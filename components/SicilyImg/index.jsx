      ...
      <div className={styles.sicilyContainer}>
        <div className={styles.paragraphContaine}>
          <p>
            ...
            <br /> Terra di suli, d’amuri e d’incantu, <br />
            terra di spartenzi,di duluri e di chiantu.
            <br />
            Terra chi cunfunni e la menti scumpigghia,
            <br /> terra ricca di storia e di ogni meravigghia.
            <br /> Terra dunni lu suli darré u mari scumpari,
            <br /> mentri u cielu di russu accumincia a pittari,
            <br /> prima di lassari lu só postu a la luna, <br />e putilla
            ammirari é na gran furtuna.
          </p>
